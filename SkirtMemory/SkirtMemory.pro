...
#---------------------------------------------------------------------
# This is the SkirtMemory console application. It handles the command
...
# ensure that SkirtMemory.cpp gets recompiled to update the version number and time stamp
A_QUOTE = "\'\"\'"
A_SEMICOLON = "\';\'"
versionTarget.target = ../../git/SkirtMemory/git_version.h
versionTarget.depends = FORCE
versionTarget.commands = cd ../../git ; \
                         echo const char* git_version = $$A_QUOTE`git rev-list HEAD | wc -l`-`git describe --dirty --always` $$A_QUOTE $$A_SEMICOLON > SkirtMemory/git_version.h ; \
                         cd $$OUT_PWD
PRE_TARGETDEPS += ../../git/SkirtMemory/git_version.h
...
HEADERS += \
    SkirtMemory.hpp \
    SkirtMemoryCommandLineHandler.hpp

SOURCES += \
    SkirtMemory.cpp \
    SkirtMemoryCommandLineHandler.cpp
