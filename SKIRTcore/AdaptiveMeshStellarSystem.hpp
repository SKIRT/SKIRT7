...
#ifndef ADAPTIVEMESHSTELLARSYSTEM_HPP
#define ADAPTIVEMESHSTELLARSYSTEM_HPP
...
/** The AdaptiveMeshStellarSystem class represents stellar systems defined by the stellar density
    ...
    AdaptiveMeshStellarSystem class allows selecting the data columns respectively containing the
...
class AdaptiveMeshStellarSystem : public StellarSystem
{
    Q_OBJECT
    Q_CLASSINFO("Title", "a stellar system imported from an adaptive mesh data file")
...
public:
    ...
    Q_INVOKABLE AdaptiveMeshStellarSystem();
...
public:
    /** Sets the file containing the adaptive mesh data that defines this stellar system. */
    Q_INVOKABLE void setAdaptiveMeshFile(AdaptiveMeshFile* value);

    /** Returns the file containing the adaptive mesh data that defines this stellar system. */
    ...
    /** Sets the index of the column in the data file that defines the initial stellar density
        \f$\rho\f$ for this stellar system, in \f$M_\odot\,\text{pc}^{-3}\f$ at \f$t=0\f$. */
    ...
    /** Returns the index of the column in the data file that defines the stellar density
        \f$\rho\f$ for this stellar system. */
    ...
    /** Sets the index of the column in the data file that defines the metallicity \f$Z\f$ of the
        stellar population for this stellar system, as a dimensionless fraction. */
    ...
    /** Returns the index of the column in the data file that defines the age of the stellar
        population for this stellar system. */
...
public:
    ...
    /** This function returns the dimension of the stellar system, which for this class is always 3
...
#endif // ADAPTIVEMESHSTELLARSYSTEM_HPP
