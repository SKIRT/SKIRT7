...
public:
    ...
    /** This function caches the pointer to the Random object in the simulation hierarchy. */
...
protected:
    ...
    QVector<int> _assignment;   // for each value, this list defines the rank of the assigned process
    QList<size_t> _values;      // the values assigned to this process
