...
/** The TwoPhaseDustGrid class is a subclass of the CartesianDustGrid class. It can be used to add
    ...
    idea behind the TwoPhaseDustGrid class is that it represents a linear cartesian grid, but an
    ...
    with a low-density and a high-density medium. Internally, a two-phase dust structure just a
