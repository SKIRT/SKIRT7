...
/** The EnstatiteGrainComposition class represents the optical properties of Enstatite dust grains,
    ...
    - \em Amorphous silicates with enstatite-normative composition from Köhler et al. 2014 (A&A, 565, L9)
      and, together with the amorphous silicates with forsterite-normative composition replace the
      silicate grains of Jones et al. 2013 (A&A, 558, A62). The calorimetric properties are calculated in
      DustEM. */
...
protected:
    /** This function reads the raw optical and calorimetric data from resource files, and sets the
        ...
        and 1600 kg/m\f$^3\f$ specified by Kohler for amorphous Enstatite. */
