...
ParticleTreeDustGridStructure::ParticleTreeDustGridStructure()
    :  _treeType(OctTree), _extraLevels(0), _eps(0), _dmib(0), _highestWriteLevel(0)
{
}
...
double ParticleTreeDustGridStructure::extentX() const
{
    return _xmax;
}
...
double ParticleTreeDustGridStructure::extentY() const
{
    return _ymax;
}
...
double ParticleTreeDustGridStructure::extentZ() const
{
    return _zmax;
}
...
void ParticleTreeDustGridStructure::setTreeType(ParticleTreeDustGridStructure::TreeType value)
{
    _treeType = value;
}
...
ParticleTreeDustGridStructure::TreeType ParticleTreeDustGridStructure::treeType() const
{
    return _treeType;
}
...
void ParticleTreeDustGridStructure::setExtraLevels(int value)
{
    _extraLevels = value;
}
...
int ParticleTreeDustGridStructure::extraLevels() const
{
    return _extraLevels;
}
...
double ParticleTreeDustGridStructure::xmax() const
{
    return _xmax;
}
...
double ParticleTreeDustGridStructure::ymax() const
{
    return _ymax;
}
...
double ParticleTreeDustGridStructure::zmax() const
{
    return _zmax;
}
...
double ParticleTreeDustGridStructure::volume(int m) const
{
    if (m<0 || m>_Ncells)
...
int ParticleTreeDustGridStructure::whichcell(Position bfr) const
{
...
Position ParticleTreeDustGridStructure::centralPositionInCell(int m) const
{
...
Position ParticleTreeDustGridStructure::randomPositionInCell(int m) const
{
...
QList<SimulationItem*> ParticleTreeDustGridStructure::interfaceCandidates(const type_info &interfaceTypeInfo)
{
...
double ParticleTreeDustGridStructure::density(int h, int m) const
{
    TreeNode* node = getnode(m);
...
void ParticleTreeDustGridStructure::write_xy(DustGridPlotFile* outfile) const
{
...
void ParticleTreeDustGridStructure::write_xz(DustGridPlotFile* outfile) const
{
    // Output the root cell and all leaf cells that are close to the section plane
...
void ParticleTreeDustGridStructure::write_yz(DustGridPlotFile* outfile) const
{
    // Output the root cell and all leaf cells that are close to the section plane
...
void ParticleTreeDustGridStructure::write_xyz(DustGridPlotFile* outfile) const
{
...
TreeNode* ParticleTreeDustGridStructure::root() const
{
    return _tree[0];
}
...
TreeNode* ParticleTreeDustGridStructure::getnode(int m) const
{
    return _tree[_idv[m]];
}
...
int ParticleTreeDustGridStructure::cellnumber(const TreeNode* node) const
{
