...
void PseudoSersicGeometry::setIndex(double value)
{
    _n = value;
}
...
double PseudoSersicGeometry::index() const
{
    return _n;
}
...
void PseudoSersicGeometry::setRadius(double value)
{
    _reff = value;
}
...
double PseudoSersicGeometry::radius() const
{
    return _reff;
}
...
double
PseudoSersicGeometry::density(double r)
const
{
    double s = r/_reff;
...
double
PseudoSersicGeometry::randomradius()
const
{
