...
#ifndef VORONOISTELLARSYSTEM_HPP
#define VORONOISTELLARSYSTEM_HPP
...
/** The VoronoiStellarSystem class represents stellar systems defined by the stellar density and
    properties imported from a Voronoi mesh data file. The data file must have one of the supported
    formats; refer to the VoronoiMeshFile class and its subclasses. The VoronoiStellarSystem class
...
class VoronoiStellarSystem : public StellarSystem
{
    Q_OBJECT
    Q_CLASSINFO("Title", "a stellar system imported from a Voronoi mesh data file")
...
public:
    ...
    Q_INVOKABLE VoronoiStellarSystem();
...
public:
    /** Sets the file containing the Voronoi mesh data that defines this stellar system. */
    Q_INVOKABLE void setVoronoiMeshFile(VoronoiMeshFile* value);

    /** Returns the file containing the Voronoi mesh data that defines this stellar system. */
...
#endif // VORONOISTELLARSYSTEM_HPP
