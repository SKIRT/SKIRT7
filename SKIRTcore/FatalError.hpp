...
public:
    /** Constructs a fatal error with the specified error message and information about the call
        ...
        \endcode
    */
    FatalError(QString message, const char* file, int line, const char* function);
...
private:
    // the multi-line message, including source code location information
...
#define FATALERROR(message) FatalError((message),__FILE__,__LINE__,Q_FUNC_INFO)

////////////////////////////////////////////////////////////////////

#endif // FATALERROR_HPP
