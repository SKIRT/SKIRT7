...
#ifndef DustEmissivity2_HPP
#define DustEmissivity2_HPP
...
/** The DustEmissivity2 class is the abstract base class for objects that calculate the wavelength
    ...
    (both specified as arguments by the caller), and some additional assumptions. DustEmissivity2
    subclasses implement various assumptions, and in particular, whether transient heating is taken
    into account or not. */
class DustEmissivity2 : public SimulationItem
{
    Q_OBJECT
