...
{
    Q_OBJECT
    Q_CLASSINFO("Title", "a uniform smoothing kernel")

    //============= Construction - Setup - Destruction =============

public:
    /** The default constructor. */
    Q_INVOKABLE UniformSmoothingKernel();

protected:
    /** This function is empty for the current class. */
...
#endif // UNIFORMSMOOTHINGKERNEL_HPP
