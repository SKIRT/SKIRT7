...
/** QuasarSED is a class that represents a simple model for the spectral energy distributions of a
    quasar, borrowed from Stalevski et al. (2011, in preparation). It is defined in the wavelength
    range between 0.001 \f$\mu\f$m and 1000 \f$\mu\f$m and is characterized by \f[ S_\lambda
    \propto \begin{cases} \; \lambda^{1/5} & \text{if
