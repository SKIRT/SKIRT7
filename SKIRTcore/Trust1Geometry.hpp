...
/** The Trust1Geometry class is a subclass of the GenGeometry class and describes
    the geometry of a square constant density slab. It is to be used as one of the benchmark models for
    the suite of TRUST 3D benchmark models. The density is constant within the slab, and
    zero outside. The dimension of the slab are defined by \f$x_{\text{min}} = y_{\text{min}} =
    z_{\text{min}} = -5~{\text{pc}}\f$, \f$x_{\text{max}} = y_{\text{max}} = 5~{\text{pc}}\f$ and
    \f$z_{\text{max}} = -2~{\text{pc}}\f$. */
...
public:
    ...
    /** This function generates a random position from the geometry, by
        ...
        {\text{d}}{\bf{r}} = \rho({\bf{r}})\, {\text{d}}{\bf{r}}\f$. Straightforward in this slab
        geometry. */
    ...
    /** This function returns the X-axis surface density, i.e. the integration of
        ...
        {\text{d}}x. \f] Trivially zero for this geometry. */
    double SigmaX() const;
    ...
    /** This function returns the Y-axis surface density, i.e. the integration of
        ...
        {\text{d}}y. \f] Trivially zero for this geometry. */
    double SigmaY() const;
    ...
    /** This function returns the Z-axis surface density, i.e. the integration of
        ...
        {\text{d}}z. \f] Trivial for this geometry. */
    double SigmaZ() const;
