...
#ifndef GreyBodyDustEmissivity2_HPP
#define GreyBodyDustEmissivity2_HPP

#include "DustEmissivity2.hpp"

//////////////////////////////////////////////////////////////////////

/** The GreyBodyDustEmissivity2 class calculates the emissivity of a particular dust mix in a given
...
class GreyBodyDustEmissivity2 : public DustEmissivity2
{
    Q_OBJECT
...
public:
    /** Default constructor. */
    Q_INVOKABLE GreyBodyDustEmissivity2();
...
#endif // GreyBodyDustEmissivity2_HPP
