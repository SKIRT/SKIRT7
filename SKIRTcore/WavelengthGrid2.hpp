...
#ifndef WAVELENGTHGRID2_HPP
#define WAVELENGTHGRID2_HPP
...
/** WavelengthGrid2 is an abstract class that represents grids of wavelengths on which Monte Carlo
    simulations are defined. Each WavelengthGrid2 class object basically consists of a set of
...
class WavelengthGrid2 : public SimulationItem
{
    Q_OBJECT
...
protected:
    ...
    /** This function must be implemented in a subclass to initialize the vector with wavelengths.
        ...
        the abstract WavelengthGrid2 class, this function does nothing. */
    ...
    /** This function must be implemented in a subclass to initialize the vector with wavelength
        ...
        setupSelfBefore(). In the abstract WavelengthGrid2 class, this function verifies that there
