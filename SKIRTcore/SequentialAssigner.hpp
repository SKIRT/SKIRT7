...
public:
    /** This constructor can be invoked by SKIRT classes that wish to hard-code the creation of a
        ...
        process one value extra. </ol> This principle is illustrated in the following figure.
        \image html sequentialassigner_tasks.png "An illustration of how the number of tasks
        assigned to each process is determined." With the above method, all \f$n\f$ values get
