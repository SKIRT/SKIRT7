...
/** This class serves as a basic command line parser. It supports any number of filepath arguments
    ...
    option value doesn't. Filepaths and options can occur in any (mixed) order, except that an
    option value should immediately follow the corresponding option. The filepath arguments can be
...
public:
    /** This constructor parses the specified list of command line arguments (usually retrieved
        from the application object by the caller) according to the specified option list, and
    ...
    CommandLineArguments(QStringList cmdlineargs, QString options);
    ...
    bool isPresent(QString option) const;
    ...
    QString value(QString option) const;
